...
colunas_extras = ['Venc.', 'Data lanç.', 'serviço', 'COD']
...
df = df[['Venc.', 'Data lanç.', 'serviço', 'CNPJ REMETENTE', 'REMETENTE', 'CNPJ TRANSP.', 'COD', 'TRANSPORTADOR', 'DESTINATARIO', 'CNPJ DESTINATARIO', 'CTE', 'SERIE', 'VALOR', 'CHAVEnf', 'EMISSAO', 'UFIni', 'cMunIni', 'xMunIni', 'UFFim', 
